...
LANGUAGES = {
    ...
    "English": {
        ...
        "freshness_unknown": "Update date unknown",
        ...
        "dq_missing_prefecture": "Missing Prefecture",
    ...
    "한국어": {
        ...
        "source_updated": "생성",
        "db_synced": "DB 동기화",
        "freshness_current": "최신",
        "freshness_aging": "업데이트 후 시간이 지남",
        "freshness_stale": "오래된 데이터",
        "freshness_unknown": "업데이트 날짜 알 수 없음",
        "freshness_age_days": "{days}일 전",
        "stats_all": "전체",
    ...
    "中文": {
        ...
        "db_synced": "数据库同步",
        "freshness_current": "最新",
        "freshness_aging": "距上次更新已有一段时间",
        "freshness_stale": "数据较旧",
        "freshness_unknown": "更新日期未知",
        "freshness_age_days": "{days}天前",
        "stats_all": "全部",
